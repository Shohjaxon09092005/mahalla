...
import Mahalla7 from '../components/Mahalla7';
    ...
    <div className='home'>
      ...
      <div className="home_hero">
        ...
        <div className="hero_content">
          <h2>MAHALLA XALQ BILAN DAVLAT O'RTASIDAGI "KO'PRIK" VAZIFASINI AMALGA OSHIRUVCHI MUSTAQIL VA XALQCHIL TUZILMA</h2>
        </div>

      </div>
      <div className="container">

        <div className="home_news_top">
          <h4>Yangiliklar</h4>
         <NavLink  to="/yangiliklar"><button style={{cursor:"pointer"}}>Batafsil <FaChevronRight /></button></NavLink> 
        </div>
